            ...
            init : function()
                 {
                     ...
                     for (var this_tag in CAMPOS_ESPECIAIS_EMAIL){
                        this.add(this_tag,
                                 CAMPOS_ESPECIAIS_EMAIL[this_tag]
                                 );
                     }
...
CKEDITOR.plugins.add( 'especiais_autodec',
{
    init: function( editor )
    {
        var config = editor.config;
        ...
        editor.ui.addRichCombo( 'CampoEspecial_autodec',
        {
            label      : 'Campos Especiais',
            voiceLabel : 'Campos Especiais',
            command    : 'insertTimestamp',
            ...
            init : function()
                 {
                     this.startGroup( 'Campos' );
                     for (var this_tag in CAMPOS_ESPECIAIS_AUTODEC){
                        this.add(this_tag,
                                 CAMPOS_ESPECIAIS_AUTODEC[this_tag]
                                 );
                     }
...
CKEDITOR.plugins.add( 'especiais_feedback',
{
    init: function( editor )
    {
        var config = editor.config;
        ...
        editor.ui.addRichCombo( 'CampoEspecial_feedback',
        {
            label      : 'Campos Especiais',
            voiceLabel : 'Campos Especiais',
            command    : 'insertTimestamp',
            ...
            init : function()
                 {
                     this.startGroup( 'Campos' );
                     for (var this_tag in CAMPOS_ESPECIAIS_FEEDBACK){
                        this.add(this_tag,
                                 CAMPOS_ESPECIAIS_FEEDBACK[this_tag]
                                 );
                     }
