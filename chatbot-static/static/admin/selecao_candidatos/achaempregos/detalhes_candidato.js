var abrir_detalhes_candidato = function(id_cand, ja_aberta) {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      $(".remover_funcao_achaempregos").click(function(){
          var botao = $(this);
...
var abrir_importacao = function() {
  $("#div_detalhes_cand_achaempregos").hide();
  $("#div_importacao_achaempregos").show();
}

var cancelar_importacao = function() {
  $("#div_detalhes_cand_achaempregos").show();
  $("#div_importacao_achaempregos").hide();
}
...
var salvar_importacao = function(){
  ...
  $.ajax({
    ...
    success: function(data) {
        ...
        if(data['status']=='ok'){
            $("#div_importacao_achaempregos, #bt_import_cand").remove();
            $("#div_detalhes_cand_achaempregos").show();
