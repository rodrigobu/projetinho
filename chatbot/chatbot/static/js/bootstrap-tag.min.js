...
! function(c) {
    ...
    b.prototype = {
        ...
        show: function() {
            ...
            d.element.wrap(c('<div class="tags" id="id_tags_input">')).parent().on("click", function() {
                d.input.focus()
            });
            if (d.values.length) {
            ...
            d.input = c('<input type="text">').attr("placeholder", d.options.placeholder).attr("maxlength", "30").insertAfter(d.element).on("focus", function() {
